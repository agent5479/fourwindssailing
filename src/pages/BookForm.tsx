    ...
    try {
      if (HAS_LIVE_BOOKING) {
        ...
        const enquiryMessage = [
          ...
          notes,
          '',
          'Note: availability shown on the site is illustrative. Price to be announced.',
        ].join('\n');
    ...
    <form className="book-form" onSubmit={handleSubmit} noValidate>
      ...
      {!HAS_LIVE_BOOKING && (
        <p className="book-form__demo">
          Interactive preview: times are illustrative and price is to be announced.
          Submitting sends Tom a booking enquiry — nothing is confirmed until he
          replies.
        </p>
      )}
